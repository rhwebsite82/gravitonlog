...
<div class="container-fluid">
	<form action="" id="manage_attendee">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">IC</label>
							<input type="text" name="ic_birth_certificate" class="form-control form-control-sm" required value="<?php echo isset($ic_birth_certificate) ? $ic_birth_certificate : '' ?>">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="race" class="form-control form-control-sm" required value="<?php echo isset($race) ? $race : '' ?>">
						</div>
						<div class="form-group">
							<label for="" class="control-label">Age</label>
							<input type="text" name="age" class="form-control form-control-sm" required value="<?php echo isset($age) ? $age : '' ?>">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
    ...
    <input type="email" name="email" class="form-control form-control-sm" required value="<?php echo isset($email) ? $email : '' ?>">
						...
						<div class="form-group">
							...
							<input type="checkbox" name="status" id="" data-bootstrap-switch data-toggle="toggle" data-on="Present" data-off="Absent" class="switch-toggle status" data-size="xs" data-onstyle="success" data-offstyle="danger" data-width="5rem" <?php echo isset($status) && $status == '1' ? 'checked' : '' ?>>
						</div>
					</div>
				</div>
			</form>
